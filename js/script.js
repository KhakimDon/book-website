...
let book1 = [
        {
                ...
                yaer: ' 2018 год',
                pages: '152 Страниц',
                text: 'В пьесе любимая жена Отабека становиться жертвой лицимерия. Райхона была очаровательной девушкой которая любит жизнь, у нее были бол     ьшие мечты. Когда Отабек узнал, что его жена стала жертвой несправедливости он почувствовал ответственность перед ее духом. Он решает бороться с этой несправедливостью чтобы восторжествовала правосудие.По окончании работ использование автомобилей  «Дамаз» в качестве общественного транспорта, не отвечающего требованиям безопасности пассажиров, будет запрещено по всей стране, справедливость восторжествует.'
